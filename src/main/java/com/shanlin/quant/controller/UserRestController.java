package com.shanlin.quant.controller;

import com.shanlin.quant.error.CodeMessagge;
...
import com.shanlin.quant.result.TokenParam;
import com.shanlin.quant.service.UserService;
import com.shanlin.quant.utils.ConfirmThickCode;
import com.shanlin.quant.utils.MongoDbObjectUtils;
import com.shanlin.quant.utils.TokenManager;
...
public class UserRestController {
    ...
    public BaseResponse getUserInfo(String userName,String appId) {
        //System.out.println("创建的对象是i:"+mongoDbObjectUtils.getMongoObject()+" 端口是: ");
